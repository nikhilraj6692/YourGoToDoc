...
public class EmailService {
    ...
    public void sendAppointmentStatusEmail(String to, String name, String status, Long appointmentDate, 
            Long startTime, Long endTime, String type, String location, String meetingLink, 
    ...
    public void sendAppointmentReminderEmail(String to, String name, Long startTime, Long endTime,
            String type, String location, String meetingLink) throws MessagingException {
        Context context = new Context();
        context.setVariable("name", name);
